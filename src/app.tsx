...
export function App() {
  ...
  const [isGuestsModalOpen, setisGuestsoModalOpen] = useState(false)
  ...
  function openGuestsModal() {
    setisGuestsoModalOpen(true)
  }
  function closeGuestsModal() {
    setisGuestsoModalOpen(false)
  }
    ...
    <div className="h-screen flex items-center justify-center bg-pattern bg-no-repeat bg-center">
      <div className="max-w-3xl w-full px-6 text-center space-y-10">
        ...
        <p className="text-sm text-zinc-500">
          Ao planejar sua viagem com a plann.er voce automaticamente concorda <br />
          com nossos <a className="text-zinc-300 underline">termos de uso</a> e <a className="text-zinc-300 underline" href="#">politicas de privacidade</a>
        </p>
      </div>
